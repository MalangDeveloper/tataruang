      ...
      <div class="x_panel">
        ...
        <br>
          <center><button type="submit" class="btn btn-success" name="submit"><span class="oi oi-person"></span> EDIT</button>
            <a href="<?php echo base_url()?>Staff"><button type="button" class="btn btn-danger">KEMBALI</button></a>
          <a 
                            href="javascript:;"
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-data" class="modal fade">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <form class="form-horizontal" action="<?php echo base_url('Staff/ubahpass')?>" method="post" enctype="multipart/form-data" role="form">
